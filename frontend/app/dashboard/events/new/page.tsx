...
function Field({ label, placeholder, tall }: { label: string; placeholder: string; tall?: boolean }) {
  return (
    <div>
        ...
        <div className="col-span-8">
          <Card className="p-6">
            ...
            <div className="mt-6 space-y-5">
              <Field label="Event title" placeholder="Customer Rocket Launch — Artemis Demo" />
              <Field label="Client / partner" placeholder="Artemis Aerospace" />
              <div className="grid grid-cols-2 gap-4">
                <Field label="Start date & time" placeholder="02/18/2026 2:00 PM" />
                <Field label="End date & time" placeholder="02/18/2026 4:00 PM" />
              </div>
              <Field label="Location" placeholder="Wallops Flight Facility" />
              <Field label="Description" placeholder="What is this milestone, and why it matters? (short)" tall />
